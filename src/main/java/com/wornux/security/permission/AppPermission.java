...
public enum AppPermission {
    ...
    PRODUCT_EXPORT(AppResource.PRODUCT, AppAction.EXPORT),
    ...
    CATEGORY_EXPORT(AppResource.CATEGORY, AppAction.EXPORT),
    ...
    SUPPLIER_EXPORT(AppResource.SUPPLIER, AppAction.EXPORT),
    ...
    STOCK_MOVEMENT_EXPORT(AppResource.STOCK_MOVEMENT, AppAction.EXPORT),
